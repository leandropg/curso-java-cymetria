			...
			{				
				...
				switch( opcion )
				{
					...
					case 6:
						...
						ReporteSecciones reporteSecciones = new ReporteSecciones(supermercado);
						reporteSecciones.imprimirDetalle();
						break;

					case 7:
						// Imprime los productos del supemercado
						ReporteProductos reporteProductos = new ReporteProductos(supermercado);
						reporteProductos.imprimirDetalle();
						break;

					case 8:
						// Imprime el stock del supermercado
						ReporteStock reporteStock = new ReporteStock(supermercado);
						reporteStock.imprimirDetalle();
						break;
